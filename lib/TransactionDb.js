...
var genesisTXID = '0000099f0d0835bace97f7913f3f7ad2b60c6835c0ba51c85e08179d8c8430ef'; //Bdccurrency
var CONCURRENCY = 5;
...
var encodedData = require('soop').load('bdcccore/util/EncodedData', {
  base58: base58
});
var versionedData = require('soop').load('bdcccore/util/VersionedData', {
  parent: encodedData
});

var Address = require('soop').load('bdcccore/lib/Address', {
